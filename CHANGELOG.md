...
table of what plugs in and what deliberately stays out, a first use case that is real work rather
than a demo page, and the three publishing doors. It exists because `SETUP.md` is written for the
person doing the setup, and what people actually needed was one page to send ahead of it.
